...
This worked but without the Cloudfront part, add the above `.htaccess` and also create a Cname Record which references the certificate (its CName value before the '.')
...
The below should also be added in order to forward requests to HTTPS (I think)
